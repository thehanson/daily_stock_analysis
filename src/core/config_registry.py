...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LLM_EXTRA_HEADERS": {
        ...
        "description": "Optional JSON object of HTTP headers for OpenAI-compatible relay/proxy endpoints. Leave empty for official APIs; channel-specific LLM_<CHANNEL>_EXTRA_HEADERS overrides matching keys.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": True,
    ...
    "LLM_MIN_INTERVAL": {
        ...
        "description": "Minimum interval in seconds between outbound LLM requests within the same provider bucket.",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
